...
export function providerAccountToAccount(
  ...
  return {
    ...
    reservedFor: suggestion.reservedFor ?? null,
    linkedLiabilityAccountId: suggestion.linkedLiabilityAccountId ?? null,
    overdraftLimit: suggestion.overdraftLimit ?? null,
    overdraftRepaymentTarget: suggestion.overdraftRepaymentTarget ?? null,
    linkedGoalIds: [],
    syncStatus: "connected",
    lastSyncedAt: now,
    consentExpiresAt: null,
    notes: `Mapped from provider payload. ${suggestion.reason}`,
    provider,
    status: "active",
    createdAt: now,
    updatedAt: now,
